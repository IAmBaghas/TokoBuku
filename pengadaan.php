...
$sql = "SELECT ID_Buku, Kategori, Nama_Buku, Harga, Stok, Penerbit FROM buku WHERE Nama_Buku LIKE '%$search%' AND Stok <= '10'";
...
<html>
  ...
  <body>
      ...
      <div class="booklist">
      <h2>Pengadaan :</h2>
      <p style='padding-left: 0px;'>*Buku tertera sebaiknya dilakukan restock</p>
      <?php
